...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/users',
            ...
            function AuthController_createUser(request: ExRequest, response: ExResponse, next: any) {
        ...
        app.put('/api/users/:id',
            ...
            function AuthController_updateUser(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/api/users/login',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    input: {"in":"body","name":"input","required":true,"ref":"LoginDto"},
            };
        ...
        app.get('/api/users',
            ...
            function AuthController_getCurrentUser(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
